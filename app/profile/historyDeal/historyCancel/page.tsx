...
import { CreditCard, Key, Clock, User, Bell, HelpCircle, MessageCircleQuestion } from "lucide-react";
import Image from "next/image";
import Link from "next/link";
import { useRouter } from "next/navigation";

export default function HistoryCancel() {
      ...
      <div className="flex flex-1 max-w-7xl mx-auto">
        ...
        <div className="flex-1 p-8">
          <div className="flex justify-between items-center mb-6">
            <Tabs defaultValue="cancel" className="w-full" onValueChange={handleTabChange}>
              ...
              <TabsContent value="cancel" className="space-y-4">
                {[1, 2, 3].map((booking) => (
                  ...
                  >
                    <Image
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-QtBPQTJNNxOpkHOFT3lsO7jVBd06Wt.png"
