...
export default function HistoryPast() {
  ...
  const handleTabChange = (value: string) => {
    ...
    if (value === "upcoming") {
      router.push("/profile/historyDeal/historyUpcoming");
    }
  };
      ...
      <div className="flex flex-1 max-w-7xl mx-auto">
        ...
        <div className="flex-1 p-8">
          <div className="flex justify-between items-center mb-6">
            <Tabs defaultValue="past" className="w-full" onValueChange={handleTabChange}>
              ...
              <TabsContent value="past" className="space-y-4">
                {[1, 2, 3].map((booking) => (
                  <Link
                    key={booking}
                    href="#"
                    className="block flex items-start gap-4 p-4 border rounded-lg hover:shadow-md transition-shadow"
                  >
                    <Image
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-mHmeuy7WBZy4mfg2tYueYUIPGmeN8O.png"
                      alt="Hotel"
                      width={120}
                      height={80}
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-start">
                        <div className="mr-40">
                          ...
                          <p className="text-sm text-gray-600">12 tháng 2 - 13 tháng 2 · Huế</p>
                          <p className="text-sm mt-1">
                            Trạng thái: <span className="text-green-600">Đã thành công</span>
                          </p>
                        </div>
      ...
      <footer className="bg-[#003580] text-white">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="grid grid-cols-5 gap-8">
            ...
            <div>
              <h3 className="font-medium mb-4">Về Booking.com</h3>
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="#" className="hover:underline">
                    Về chúng tôi
