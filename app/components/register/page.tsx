    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-[#003580] px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Button variant="ghost" className="text-white hover:text-white/90">
            <Image
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-Ubdaf214pU4u2d3wm1fhMlZouh2IEr.png"
              alt="US Flag"
              width={20}
              height={20}
              className="mr-2"
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="max-w-md w-full space-y-6">
          <div>
            <h1 className="text-2xl font-semibold">Create a password for your new account</h1>
          </div>
          ...
          <div className="space-y-4">
            ...
            <Button className="w-full bg-[#006CE4] hover:bg-[#005ECB]">Create account</Button>
