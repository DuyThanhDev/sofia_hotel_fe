...
export default function Login() {
  ...
  const handleContinue = () => {
    if (email) {
      router.push("/components/loginPassword"); // Đường dẫn tới trang loginPassword
    } else {
      router.push("/components/register"); // Đường dẫn tới trang register
    }
  };
      ...
      <header className="bg-[#003580] px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Button variant="ghost" className="text-white hover:text-white/90">
            <Image
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-pGq7YkZtwyWmmMu41YAriKjy99myEq.png"
              alt="US Flag"
              width={20}
              height={20}
              className="mr-2"
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="max-w-md w-full space-y-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">You can sign in using your Booking.com account to access our services.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <Button onClick={handleContinue} className="w-full bg-[#006CE4] hover:bg-[#005ECB]">
              Continue with email
            </Button>
